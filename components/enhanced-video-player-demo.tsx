...
export default function EnhancedVideoPlayerDemo({ className }: EnhancedVideoPlayerDemoProps) {
  ...
  const [isDetectionsVisible, setIsDetectionsVisible] = useState(true)
  ...
  useEffect(() => {
    if (!canvasRef.current || !videoRef.current || !isDetectionsVisible || !videoLoaded) return
    ...
    const drawDetections = () => {
      ...
      // Draw each detection
      SAMPLE_DETECTIONS.forEach((detection) => {
  ...
  }, [isDetectionsVisible, videoLoaded])
